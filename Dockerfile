...
RUN jq '.dependencies["ajv-keywords"] = "3.5.2" | .dependencies["ajv"] = "6.12.6" | .resolutions["@babel/plugin-transform-private-property-in-object"] = "@babel/plugin-transform-private-property-in-object"' package.json > temp.json && \
