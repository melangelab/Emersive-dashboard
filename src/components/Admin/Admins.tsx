...
export default function Admins({ title, authType, adminType, history, onLogout }) {
  ...
  return (
    <>
      <AdminHeader adminType={adminType} authType={authType} title={title} pageLocation="Admins" onLogout={onLogout} />
